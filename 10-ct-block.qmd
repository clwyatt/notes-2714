...
scaling) or more generally by its impulse response $h_i(t)$.  For
example a block representing an system acting as integrator is typically
drawn as


![Block diagram repersenting an integrator represented symbolically.](figures/fig10_5){fig-align="center" fig-alt="see caption"}

This is equivalent to an impulse response $h(t) = u(t)$ so that it might
also be drawn as

![Block diagram repersenting an integrator represented by its impulse response.](figures/fig10_6){fig-align="center" fig-alt="see caption"}
...
- A single block is equivalent to convolution with the impulse response
  ...
  ![Block diagram representation as convolution of input with impulse response.](figures/fig10_7){fig-align="center" fig-alt="see caption"}
  
- Using the associative property, a series connection of two blocks
  becomes

  ![Block diagram of a series connection representation as convolution of two impulse responses.](figures/fig10_8){fig-align="center" fig-alt="see caption"}
...
- Using the distributive property, a parallel connection of two blocks
  ...
  ![Block diagram of a parallel connection representation as summation of two impulse responses.](figures/fig10_9){fig-align="center" fig-alt="see caption"}
...
- In the feedback connection let $w(t)$ be the output of the summation
  ...
  ![Block diagram of a feedback connection.](figures/fig10_10){fig-align="center" fig-alt="see caption"}
...
![Block diagram representing scaling of a signal.](figures/fig10_11){fig-align="center" fig-alt="see caption"}
...
![Example block diagram of a system with two parallel connections.](figures/fig10_12){fig-align="center" fig-alt="see caption"}
::::
:::
...
![Example block diagram of a system with two parallel connections followed by a series connection.](figures/fig10_12_2){fig-align="center" fig-alt="see caption"}
...
![Block diagram of a first order differential system.](figures/fig10_13){fig-align="center" fig-alt="see caption"}
...
![Block diagram of a first order integral system.](figures/fig10_14){fig-align="center" fig-alt="see caption"}
...
![Block diagram of a first order integral system using a single integrator.](figures/fig10_15){fig-align="center" fig-alt="see caption"}
...
![Block diagram of a second-order integral system](figures/fig10_16){fig-align="center" fig-alt="see caption"}

This is equivalent to two systems in series

![Second-order integral system represented as two systems in series.](figures/fig10_17){fig-align="center" fig-alt="see caption"}

Recall that, from the commutative property of convolution, the order of
systems in series can be swapped\

![Second-order integral system represented as two systems in series, but in opposite order (interchanged).](figures/fig10_18){fig-align="center" fig-alt="see caption"}
...
![Block diagram of a second-order integral system using two integrators.](figures/fig10_19){fig-align="center" fig-alt="see caption"}
...
![Basic block diagram components in CT and thier electrical circuit implementations.](figures/fig10_20){fig-align="center" fig-alt="see caption"}
