...
![Single pole, single throw switch connected to a unit DC source.](figures/fig2_1){fig-align="center" fig-alt="Diagram showing a single pole, single throw switch connected to a unit DC source." #fig-spst-switch}
...
![Plot of the unit step function. It turns on at the time origin and stays on forever.](figures/fig2_2){fig-align="center" fig-alt="plot showing a unit step function. See caption." #fig-step-function}
...
![Plot of the CT delta function.](figures/fig2_3){fig-align="center" fig-alt="vertical arrow centered at time origin" #fig-delta-function}
...
![Plot of the expoential function with real, positive parameter.](figures/fig2_4){fig-align="center" fig-alt="plot. refer to caption." #fig-real-pos-exp}


When $a < 0$ and $C > 0$, $x(t) = C e^{a t}$ looks like:

![Plot of the expoential function with real, negative parameter.](figures/fig2_5){fig-align="center" fig-alt="plot. refer to caption." #fig-real-neg-exp}
...
![The CT complex sinusoid at a specific point in time.](images/CT_complexsinusoid_visual.svg){fig-alt="A figure visualizing the CT complex sinusoid at a specific point in time." #fig-ct-complex-sinusoid}
