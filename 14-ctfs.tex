...
\begin{center}
\includegraphics[scale=0.7]{figures/ctfs_exampleplot.png}
\end{center}
$\blacksquare$
\end{example}
...
\right.
  ...
  \begin{center}
    \includegraphics[scale=0.7]{figures/ctfs_exampleplot2.png}
  \end{center}
  We can plot the truncated approximation for increasing number of terms N, the squared error, and the total error.
  \begin{center}
    \includegraphics[scale=0.5]{figures/squarewaveapprox1.png}
  \end{center}
  \begin{center}
    \includegraphics[scale=0.5]{figures/squarewaveapprox2.png}
  \end{center}
  \begin{center}
    \includegraphics[scale=0.5]{figures/squarewaveapprox3.png}
  \end{center}
