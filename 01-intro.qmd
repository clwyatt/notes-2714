...
used extensively in later TLOs. In the following LG refers to the course textbook
"Signal Processing and Linear Systems" by Lathi and Green.
...
TLO 10: CT block diagrams (LG §6.5)

TLO 11: DT block diagrams (LG §8.5)
...
TLO 19: DT Frequency Response (LG §10.5 and §12.1 through §12.2)

TLO 20: Frequency Selective Filters in CT (LG §4.5)

TLO 21: Frequency Selective Filters in DT (LG §12.3)
